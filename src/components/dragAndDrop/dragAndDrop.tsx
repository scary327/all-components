...
const DragAndDrop = () => {
	const [boards, setBoards] = useState<IBoard[]>([
		...
		},
		{
			...
			name: 'В разработке',
			items: [
				{ id: 3, title: 'shodit v store' },
				{ id: 4, title: 'kupit bread' },
			],
		},
		{
			id: 3,
			...
			items: [
				{ id: 5, title: 'Pokushat' },
				{ id: 6, title: 'A kogo ebet chto ya delayu?' },
				{ id: 7, title: 'jopa jopa' },
			],
		},
	])
	...
	function dropCardHandler(e: DragEvent<HTMLDivElement>, board: IBoard): void {
		board.items.push(currentCard as ICard)
		const currentIndex = currentBoard?.items.indexOf(currentCard as ICard)
		currentBoard?.items.splice(currentIndex as number, 1)
	}
